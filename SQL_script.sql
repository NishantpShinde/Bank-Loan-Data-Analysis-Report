...
SELECT FORMAT(SUM(total_payment), "") AS Good_Loan_amount_received FROM bank_loan_data
WHERE loan_status = 'Fully Paid' OR loan_status = 'Current';
...
SELECT FORMAT(SUM(loan_amount), "") AS Bad_Loan_Funded_amount FROM bank_loan_data
WHERE loan_status = 'Charged Off';

-- Bad Loan Amount Received
SELECT FORMAT(SUM(total_payment), "") AS Bad_Loan_amount_received FROM bank_loan_data
WHERE loan_status = 'Charged Off';
...
SELECT
        ...
        FORMAT(SUM(total_payment), "") AS Total_Amount_Received,
        FORMAT(SUM(loan_amount), "") AS Total_Funded_Amount,
...
-- MONTH
-- MONTHNAME(issue_date) same as DATE_FORMAT('2021-02-11', '%M')
SELECT 
